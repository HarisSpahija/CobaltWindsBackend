...
insert into competitions(id, name, description, max_team_count, start_date, registration_start_date, status) VALUES ('competition-uuid-1', 'Cobalt Winds Summer Showdown', 'Are you ready for rumble?', 128, '2023-05-01', '2023-03-05', 0);
insert into competitions(id, name, description, max_team_count, start_date, registration_start_date, status) VALUES ('competition-uuid-2', 'Cobalt Winds Mini March Battle', 'Are you ready for rumble?', 32, '2023-03-01', '2022-02-01', 1);
insert into competitions(id, name, description, max_team_count, start_date, registration_start_date, status) VALUES ('competition-uuid-3', 'Cobalt Winds Spring Cup', 'Are you ready for rumble?', 64, '2023-02-01', '2022-12-01', 2);
insert into competitions(id, name, description, max_team_count, start_date, registration_start_date, status) VALUES ('competition-uuid-4', 'Cobalt Winds Winter League', 'Are you ready for rumble?', 256, '2022-09-01', '2022-08-01', 3);
...
insert into competition_registrations (competition_id, team_id) VALUES ('competition-uuid-3', 'team-uuid-1');
insert into competition_registrations (competition_id, team_id) VALUES ('competition-uuid-3', 'team-uuid-2');
